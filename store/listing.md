...
Исходный код открыт целиком, каждая его правка собирается и проверяется автоматически, и лог каждой сборки виден всем: github.com/Cryptoteep/smtu-schedule-android
